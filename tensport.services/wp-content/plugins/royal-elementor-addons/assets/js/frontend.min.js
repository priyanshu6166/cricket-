    ...
    var e = {
            ...
            widgetSection: function(i) {
                function a(t) {
                    ...
                    function a() {
                        ...
                        var d = function() {
                            ...
                            "fixed" != T && ("top" === o && (e > _ ? r() : e <= _ && i.css({
                                ...
                                position: "relative"
                            }))), "relative" !== T && (e > w ? "yes" == i.data("wpr-replace-header") ? "yes" === i.data("wpr-sticky-hide") ? (e >= _ && i.addClass("wpr-visibility-hidden"), e < h && i.next().addClass(b).addClass("wpr-" + u + "-in")) : (i.addClass("wpr-visibility-hidden"), i.next().addClass(b).addClass("wpr-" + u + "-in")) : i.addClass("wpr-sticky-header") : e <= w && ("yes" == i.data("wpr-replace-header") ? (i.next().removeClass(b), i.removeClass("wpr-visibility-hidden"), i.next().removeClass("wpr-" + u + "-in")) : i.removeClass("wpr-sticky-header"))), "yes" === i.data("wpr-sticky-hide") && e >= _ && (e < h ? "yes" === i.data("wpr-replace-header") ? (i.next().removeClass("wpr-" + u + "-out"), i.next().addClass("wpr-" + u + "-in")) : (i.removeClass("wpr-" + u + "-out"), i.addClass("wpr-" + u + "-in")) : "yes" === i.data("wpr-replace-header") ? (i.next().removeClass("wpr-" + u + "-in"), i.next().addClass("wpr-" + u + "-out")) : (i.removeClass("wpr-" + u + "-in"), i.addClass("wpr-" + u + "-out"))), clearTimeout(f), f = setTimeout(() => {
                                h = e
                            }, 10)
                        };
                        "sticky" == T ? t(window).scroll(d) : "fixed" == T && (r(), t(window).scroll(d)), "yes" == i.data("wpr-replace-header") && 0 != i.next().length && i.next().get(0).style.setProperty("--wpr-animation-duration", j);
                        let f
                    }
                    ...
                    function r() {
                        ...
                        "yes" === i.data("wpr-sticky-hide") && h < m.scrollTop() || ("" == v && (v = "fixed"), i.css({
                            position: v
                        }), t(".wpr-close-cart span").trigger("click"))
                    }

                    function s() {
                        t("#wpadminbar").length && (S = t("#wpadminbar").css("height").slice(0, t("#wpadminbar").css("height").length - 2), "top" === o && "fixed" == i.css("position") && (i.css("top", +S + z + "px"), i.css("bottom", "auto")))
                    }
                    var n = e.editorCheck() ? i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-position-type") : i.attr("data-wpr-position-type"),
                        ...
                        v = e.editorCheck() ? i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-sticky-type") : i.attr("data-wpr-sticky-type"),
                        b = i.next().hasClass("e-con") ? "wpr-hidden-header-flex" : "wpr-hidden-header",
                        _ = i.offset().top,
                        x = t(window).height(),
                        C = i.outerHeight(!0),
                    ...
                    if (0 < i.closest("div[data-elementor-type=\"wp-post\"]").length ? g = i.closest("div[data-elementor-type=\"wp-post\"]") : 0 < i.closest("div[data-elementor-type=\"header\"]").length ? g = i.closest("div[data-elementor-type=\"header\"]") : 0 < i.closest("div[data-elementor-type=\"footer\"]").length && (g = i.closest("div[data-elementor-type=\"footer\"]")), i.find(".wpr-sticky-section-yes-editor").length || (n = i.attr("data-wpr-position-type"), o = i.attr("data-wpr-position-location"), d = i.attr("data-wpr-position-offset"), p = i.attr("data-wpr-sticky-devices"), c = i.attr("data-wpr-active-breakpoints"), y = i.attr("data-wpr-z-index")), "top" === o && "auto" === i.css("top")) {
                        var z = 0;
                        i.css("top", 0)
                    } else var z = +i.css("top").slice(0, -2);
            ...
            widgetGrid: function(a) {
                ...
                function d(e, r = "") {
                    var s = a.find(".wpr-grid"),
                        ...
                        D, W, L, E, l;
                    "" != r && (n = r);
                    for (var B = a.attr("class"), B = B.split(" "), M = 0; M < B.length - 1; M++) - 1 !== B[M].search(/mobile\d/) && (m = B[M].slice(-1)), -1 !== B[M].search(/mobile_extra\d/) && (D = B[M].slice(-1)), -1 !== B[M].search(/tablet\d/) && (h = B[M].slice(-1)), -1 !== B[M].search(/tablet_extra\d/) && (W = B[M].slice(-1)), -1 !== B[M].search(/widescreen\d/) && (E = B[M].slice(-1)), -1 !== B[M].search(/laptop\d/) && (L = B[M].slice(-1));
                    ...
                    R >= A && null != G.mobile ? (w = m, u = v, y = b) : H >= A && null != G.mobile_extra ? (w = D ? D : h, u = _, y = x) : V >= A && null != G.tablet ? (w = h, u = C, y = k) : N >= A && null != G.tablet_extra ? (w = W ? W : h, u = T, y = S) : U >= A && null != G.laptop ? (w = L ? L : g, u = P, y = O) : F > A ? (w = g, u = e.gutter_hr, y = e.gutter_vr) : (w = E ? E : g, u = j, y = z), 8 < w && (w = 8), "string" == typeof w && -1 !== w.indexOf("pro") && (w = 3), q = s.width() + u - .3, n.outerWidth(Math.floor(q / w - u)), n.css("margin-bottom", y + "px"), 1 === w && n.last().css("margin-bottom", "0");
                    var X = -1;
                    if (o.each(function() {
                    ...
                    l = d, "list" === d && (d = "fitRows"), "default" !== e.filters_animation && (I = 0);
                    s.isotopewpr({
                        layoutMode: d,
                        masonry: {
                            gutter: u
                            ...
                            success: function(e) {
                                ...
                                t.ajax({
                                    ...
                                    success: function(e) {
                                        ...
                                        }), L.find(".wpr-pagination-loading").hide(), 1 < l ? "load-more" === _.pagination_type && L.find(".wpr-load-more-btn").fadeIn() : (L.find(".wpr-pagination-finish").fadeIn(1e3), L.delay(2e3).fadeOut(1e3), setTimeout(function() {
                ...
                if (u.length) {
                    ...
                    if ("undefined" != typeof _ && !1 !== _) {
                        if (_ = JSON.parse(u.attr("data-settings")), a.find(".woocommerce-result-count").length) {
                            ...
                            (!S || e.editorCheck()) && (S = a.find(".wpr-grid-item").length, localStorage.setItem(T, S));
                            var j = _.query_posts_per_page ? _.query_posts_per_page : parseInt(S);
                            if (isNaN(j) || 0 >= j) return;
                            var z = 1,
                                P = a.find(".wpr-grid-current-page");
                            P.length && (z = parseInt(P.text().trim()) || 1), 1 == P && S != a.find(".wpr-grid-item").length && (S = a.find(".wpr-grid-item").length);
                            var O = C.match(/(\d+)(?!.*\d+)/),
                                q = O ? parseInt(O[1].trim()) : j;
                            if (isNaN(q) || 0 >= q) return;
                            var A = (z - 1) * j + 1,
                                I = Math.min(A + j - 1, q);
                            C = C.replace(/\d+\u2013\d+/, A + "\u2013" + I), a.find(".woocommerce-result-count").text(C)
                        }
                        ...
                        if (u.on("arrangeComplete", function(e, i) {
                                ...
                                for (var l in i) {
                                    (0 == W || l > W - 1) && (n += _.animation_delay, a.find(i[l].element).find(".wpr-grid-item-inner").css({
                                        opacity: "1",
                                        top: "0",
                                        transform: "scale(1)",
                            ...
                            if (a.find(".wpr-grid-pagination").length && !e.editorCheck()) {
                                var L = a.find(".wpr-grid-pagination"),
                                    E = ".elementor-element-" + a.attr("data-id"),
                                    B = !1,
                                    M = !1;
                                "infinite-scroll" === _.pagination_type && (M = 300, B = E + " .wpr-load-more-btn"), u.infiniteScroll({
                                    path: E + " .wpr-grid-pagination a",
                                    hideNav: B,
                                    append: !1,
                                    history: !1,
                                    scrollThreshold: M,
                                    ...
                                    L.find(".wpr-load-more-btn").hide(), L.find(".wpr-pagination-loading").css("display", "inline-block")
                                });
                                var R = 0;
                                u.on("load.infiniteScroll", function(e, i) {
                                    R++;
                                    var o = t(i).find(E).find(".wpr-grid-item");
                                    ...
                                    if (u.infiniteScroll("appendItems", o), u.isotopewpr("appended", o), o.imagesLoaded().progress(function() {
                                        ...
                                        }), L.find(".wpr-pagination-loading").hide(), _.pagination_max_pages - 1 === R) L.find(".wpr-pagination-finish").fadeIn(1e3), L.delay(2e3).fadeOut(1e3), setTimeout(function() {
                                        L.find(".wpr-pagination-loading").hide()
                                    }, 500);
                                    else if ("load-more" === _.pagination_type && (L.find(".wpr-load-more-btn").fadeIn(), a.find(".wpr-grid-filters").length && "*" !== a.find(".wpr-active-filter").attr("data-filter") && 0 < a.find(".wpr-active-filter").length)) {
                                ...
                                }), L.find(".wpr-load-more-btn").on("click", function() {
                        ...
                        var H = a.attr("class"),
                            V = H.match(/wpr-grid-slider-columns-\d/) ? +H.match(/wpr-grid-slider-columns-\d/).join().slice(-1) : 2,
                            N = H.match(/columns--widescreen\d/) ? +H.match(/columns--widescreen\d/).join().slice(-1) : V,
                            U = H.match(/columns--laptop\d/) ? +H.match(/columns--laptop\d/).join().slice(-1) : V,
                            F = H.match(/columns--tablet\d/) ? +H.match(/columns--tablet\d/).join().slice(-1) : 2,
                            G = H.match(/columns--tablet_extra\d/) ? +H.match(/columns--tablet_extra\d/).join().slice(-1) : F,
                            X = H.match(/columns--mobile_extra\d/) ? +H.match(/columns--mobile_extra\d/).join().slice(-1) : F,
                            Y = H.match(/columns--mobile\d/) ? +H.match(/columns--mobile\d/).join().slice(-1) : 1,
                            J = _.sliderRows,
                        ...
                        if (0 < K.length && 0 < Z.length) {
                            ...
                            0 < $ && (t(window).on("load", function() {
                                t(window).width() <= a.outerWidth() + K.outerWidth() + Z.outerWidth() + $ && (K.addClass("wpr-adjust-slider-prev-arrow"), Z.addClass("wpr-adjust-slider-next-arrow"))
                            }), t(window).smartresize(function() {
                                t(window).width() <= a.outerWidth() + K.outerWidth() + Z.outerWidth() + $ ? (K.addClass("wpr-adjust-slider-prev-arrow"), Z.addClass("wpr-adjust-slider-next-arrow")) : (K.removeClass("wpr-adjust-slider-prev-arrow"), Z.removeClass("wpr-adjust-slider-next-arrow"))
                            }))
                        }
                        if (a.find(".slick-dots").length && a.hasClass("wpr-grid-slider-dots-horizontal")) {
                            ...
                            a.find(".slick-dots").length && a.find(".slick-dots").css("width", ee), t(window).smartresize(function() {
                                setTimeout(function() {
                    ...
                    if (te.observe(a[0], {
                        ...
                        var ie = u.find(".wpr-grid-item-add-to-cart").find("i"),
                            ae = ie.attr("class");
                        ie.length && (ae = ae.substring(ae.indexOf("fa-"), ae.length)), t("body").on("adding_to_cart", function(e, t) {
                            t.fadeTo("slow", 0)
                            ...
                            ie.length && (s.find("i").removeClass(ae).addClass("fa-check"), setTimeout(function() {
            ...
            widgetCountDown: function(i) {
                ...
                function r() {
                    ...
                    if (!e.editorCheck()) {
                        if (a.hasOwnProperty("hide-timer") && s.hide(), a.hasOwnProperty("hide-element") && t(a["hide-element"]).hide(), !a.hasOwnProperty("message") || i.children(".elementor-widget-container").children(".wpr-countdown-message").length || i.children(".wpr-countdown-message").length || s.after("<div class=\"wpr-countdown-message\">" + a.message + "</div>"), a.hasOwnProperty("redirect")) {
                            var r = new URL(a.redirect);
                            ["http:", "https:"].includes(r.protocol) && (window.location.href = r.href)
                        }
